...
OUTDIR=results/bench1/ggml_bf16_to_bf16
mkdir -p "$OUTDIR"

CONFIGS=(
    "configs/llama-2-13b-chat-hf.gemm"
    "configs/llama-3.1-8b.gemm"
    "configs/phi-3-mini-128k-instruct.gemm"
    "configs/llama-2-7b-chat-hf.gemm"
    "configs/llama-3.2-1b.gemm"
    "configs/qwen2-7b.gemm"
)
